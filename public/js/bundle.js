      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://127.0.0.1:8050/api/v1/users/logout');
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error loggin out');
...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoibGFrc2hheS1zb29kIiwiYSI6ImNrZWFicmI4bzJlbGoyc29iaWFtd3Z6cnkifQ.H0Rzh8iSJ37qYmSBOXGnyg';
  var map = new mapboxgl.Map({
    container: 'map',
    //targeting element with id=map in the rendered html
    style: 'mapbox://styles/lakshay-sood/ckeabunea050h19qhyhms4wjn',
    logoPosition: 'top-left',
    //so that its not visible
    maxZoom: 10,
    // scrollZoom: false,
    // doubleClickZoom: false,
    interactive: false // maxBounds: lngLatBounds
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'top',
      closeOnClick: false
    }).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"))).addTo(map); //## adding popup for each location of tour
  ...
  var locCoordinates = locations.map(function (loc) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:8050/api/v1/users/update-password' : 'http://127.0.0.1:8050/api/v1/users/update-me';
            _context.next = 4;
...
var stripeSession = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    var stripe, sessionRes;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IpuDuSDs8Wx0TszP9BbAikg3s70tHfxG0w6LqsXCJq2rHbBCyc2Y17200Iw3sKriyBlUEUfiqp0aDF9sunWZN8G00Qe1WNgcR');
            _context.next = 4;
            return _axios.default.get("http://127.0.0.1:8050/api/v1/bookings/create-session/".concat(tourId));
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Error in Processing Payment');
  ...
  return function stripeSession(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
console.log('hello from index'); // # DOM ELEMENTS
...
var bookTourButton = document.querySelector('#book-tour-btn'); // VALUES
// # DELEGATION

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); //dataset property converts the name to camelCase
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // we need to send data as "multipart formdata" cuz thats how photo can be sent
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var saveBtn, currentPassword, password, confirmPassword;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
if (bookTourButton) {
  var tourId = bookTourButton.dataset.tourId; //dataset property converts the name to camelCase

  bookTourButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _stripe.stripeSession)(tourId);
